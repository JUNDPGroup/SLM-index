...
public:
    ...
    void write_baseline_point_query(ExpRecorder);
    void write_secure_point_query(ExpRecorder);
    void write_window_query(ExpRecorder);
    void write_baseline_window_query(ExpRecorder expRecorder);
    void write_secure_window_query(ExpRecorder expRecorder);
